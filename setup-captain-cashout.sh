...
if [ -f "DATABASE/MIGRATIONS/betshopme_8.sql" ]; then
    print_status "Importing database schema..."
    mysql -u captain_cashout_user -pCaptainCashout2024! captain_cashout < DATABASE/MIGRATIONS/betshopme_8.sql
...
echo "3. Start WebSocket services with: cd PTWebSocket && pm2 start ecosystem.config.js"
